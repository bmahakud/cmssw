...
void PATMuonProducer::produce(edm::Event & iEvent, const edm::EventSetup & iSetup)
{
  ...
  for(auto& muon: *patMuons){
    ...
    if(computePuppiCombinedIso_){ 
      ...
      muon.setSelector(reco::Muon::PuppiIsoLoose2016, puppiCombinedIsolationPAT<0.255);
      muon.setSelector(reco::Muon::PuppiIsoMedium2016, puppiCombinedIsolationPAT<0.205);
      muon.setSelector(reco::Muon::PuppiIsoTight2016, puppiCombinedIsolationPAT<0.115);
      muon.setSelector(reco::Muon::PuppiIsoLoose2017, puppiCombinedIsolationPAT<0.28);
      muon.setSelector(reco::Muon::PuppiIsoMedium2017, puppiCombinedIsolationPAT<0.23);
      muon.setSelector(reco::Muon::PuppiIsoTight2017, puppiCombinedIsolationPAT<0.13);
    }
